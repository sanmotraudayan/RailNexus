  ...
  return (
    <div className="bg-white h-[72px] flex items-center justify-between px-6 border-b border-grey-100">
      <div className="flex items-center space-x-4">
        <div className="w-12 h-12 bg-grey-100 rounded-full flex items-center justify-center text-[10px] text-grey-600 font-bold border border-grey-300">
          EMBLEM
        </div>
        <div className="flex flex-col">
          <span className="font-semibold text-navy-900 text-[15px] leading-tight">Ministry of Railways</span>
          <span className="text-grey-600 text-[11px]">Government of India</span>
        </div>
      </div>
      
      <div className="flex flex-col items-center justify-center">
        <h1 className="text-navy-900 font-bold text-[18px]">RailNexus — Intelligent Block Planning</h1>
        ...
        {user ? (
          <>
            <div className="flex flex-col items-end">
              ...
              <span className="text-[11px] text-grey-600">{ROLES[user.role]?.label}</span>
            </div>
